"""Environnement Alembic du module `tenants`.

La table de version vit **dans le schéma du module**, `tenants.alembic_version` : aucun module ne
...
from modules.socle.tenants import tables
