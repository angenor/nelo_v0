"""Environnement Alembic du module `personnes`.

La table de version vit **dans le schéma du module**, `personnes.alembic_version` : aucun module ne
...
from modules.socle.personnes import tables
