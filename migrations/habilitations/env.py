"""Environnement Alembic du module `habilitations`.

La table de version vit **dans le schéma du module**, `habilitations.alembic_version` : aucun module ne
...
from modules.socle.habilitations import tables
