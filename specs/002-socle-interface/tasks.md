...
- [ ] T058 [US4] *(reste à faire à la main par l'utilisateur ; ce qui s'automatise est dans P-05, installabilité jugée par Chromium comprise)* Dérouler le parcours à la main du [quickstart.md § US4](quickstart.md) sur Chrome et sur Safari, noter la date et le résultat dans `docs/progress.md` ; vérifier T050 à T052 et P-05 passent
