...
// Les trois fichiers du premier affichage sont préchargés ; leur adresse porte l'empreinte de
// la construction, d'où l'import plutôt qu'une adresse écrite dans nuxt.config.ts.
